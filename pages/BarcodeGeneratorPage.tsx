                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 md:p-12 transition-shadow duration-300">
                    ...
                    <div className="w-full bg-slate-50 dark:bg-slate-700/50 rounded-lg p-6 min-h-[150px] flex items-center justify-center">
                        {displayValue ? (
                            ...
                            <p className="text-slate-400 dark:text-slate-500">Your barcode will appear here</p>
                        )}
                    </div>
                </div>
                 <footer className="text-center mt-8 text-sm text-slate-400 dark:text-slate-500">
                    <p>Powered by React & Tailwind CSS. Barcodes generated using jsBarcode.</p>
                </footer>
            </div>
        </div>
    );
